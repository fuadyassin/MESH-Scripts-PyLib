...
def generate_mesh_class_ini_from_excel(excel_file, output_file="MESH_class_output.ini", num_cels=None, lat=None, lon=None, sheet_name='class_ini'):
    ...
    >>> gen_classini(excel_file="D:/Coding/GitHub/Repos/MESH-Scripts-PyLib/MESHpyPreProcessing/meshparametersvalues2.xlsx", "MESH_output2.ini", num_cels=7408, lat=53.18, lon=-99.25)
